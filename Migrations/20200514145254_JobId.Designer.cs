...
namespace JobSearch.Migrations
{
    ...
    [Migration("20200514145254_JobId")]
    partial class JobId
    {
            ...
            modelBuilder.Entity("JobSearch.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8a813413-f541-4fd6-96df-4a7b33b94633",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECe7cM4bWavBfiaVBec9W3NQ/TBICUHKIfyeEbCw4suKaQfqEmsuZmkImTF8zWDNJA==",
            ...
            modelBuilder.Entity("JobSearch.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("JobSearch.Models.Company", "Company")
                        .WithOne("ApplicationUser")
                        .HasForeignKey("JobSearch.Models.ApplicationUser", "CompanyId");
